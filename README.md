...
Веб-приложение для работы с электронными таблицами (spreadsheet), документов, формул, форматирования и горячих клавиш. Реализовано на React + TypeScript + Redux Toolkit. Данные хранятся в `localStorage` (mock‑бэкенд).
